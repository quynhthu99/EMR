                  ...
                  <a-tabs v-model:activeKey="activeKey" type="card">
                    <a-tab-pane key="1" tab="Check box">
                      <a-checkbox-group disabled style="width: 100%">
                              ...
                              <a-checkbox value="A">Acute edema</a-checkbox>
                              <a-checkbox value="B">Acute respiratory disease</a-checkbox>
                              <a-checkbox value="C">Pulmonary edema</a-checkbox>
                              <a-checkbox value="D">Lung structure</a-checkbox>
          ...
          <a-form-item label="Kiểu hiển thị">
            <a-tabs v-model:activeKey="addActiveKey" type="card">
              ...
              <a-tab-pane key="1" tab="Check box">
                <div class="ml-2">
                  <a-checkbox-group style="width: 100%">
                      ...
                      <a-col :span="26  ">
                        <a-form-item label="Giá trị " name="description">
                          <div class= "flex gap-2">
                          <a-textarea v-model:value="form.description" :rows="1" placeholder="Hãy nhập giá trị "
                                      allow-clear />
              ...
              <a-tab-pane key="3" tab="Select ">
                ...
                <a-select show-search placeholder="Select a person" style="width: 611px"
